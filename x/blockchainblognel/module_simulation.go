...
import (
	...
	"blockchain-blog-nel/testutil/sample"
	blockchainblognelsimulation "blockchain-blog-nel/x/blockchainblognel/simulation"
...
var (
	_ = sample.AccAddress
	_ = blockchainblognelsimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	blockchainblognelGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&blockchainblognelGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreatePost,
		blockchainblognelsimulation.SimulateMsgCreatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		blockchainblognelsimulation.SimulateMsgCreateComment(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		blockchainblognelsimulation.SimulateMsgDeleteComment(am.accountKeeper, am.bankKeeper, am.keeper),
	))
